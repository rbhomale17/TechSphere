...
const Piechart = () => {
  ...
  return (
    <div className="w-90 m-auto">
      <div className="flex flex-row md:flex-row justify-center items-center md:space-x-8">
        ...
        <div className="flex flex-col md:flex-col justify-center items-center md:space-x-8">
          ...
          <div className="container mx-auto p-6 bg-white shadow-md rounded-lg">
            ...
            <div className="w-96 h-96 md:w-96 md:h-96 relative">
              <Pie
                data={{
                  labels: [
          ...
          <div className="container mx-auto mt-4">
            ...
            <table className="table-auto mt-2 w-96">
              <thead>
                <tr>
